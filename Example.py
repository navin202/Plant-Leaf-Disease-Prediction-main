...
filepath = r'E:\Plant-Leaf-Disease-Prediction-main\model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread(r'E:\Plant-Leaf-Disease-Prediction-main\Dataset\test\0bbf4db7-38a1-4d5c-8fd7-503e9f37ef8f___Matt.S_CG 7848.JPG')
